...
extern int early_init_dt_scan_reserve_memory(unsigned long, const char *, int, void *);
 ...
 */
/* fix const struct machine_desc * __init setup_machine_fdt(unsigned int dt_phys) */
struct machine_desc * __init setup_machine_fdt(unsigned int dt_phys)
{
/* fix	const struct machine_desc *mdesc, *mdesc_best = NULL; */
