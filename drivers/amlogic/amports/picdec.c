...
extern int find_reserve_block(const char *, int);
extern int find_reserve_block_by_name(const char *);
extern unsigned long long get_reserve_block_addr(int);
extern unsigned long long get_reserve_block_size(int);
