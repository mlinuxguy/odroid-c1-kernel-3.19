...
/* fix static struct mmc_claim aml_sdhc_claim; was removed */
...
/* fix    spin_lock_init(&aml_sdhc_claim.lock); */
...
/* fix        mmc->alldev_claim = &aml_sdhc_claim; */
...
/* fix            mmc->host_rescan_disable = true; */
			mmc->rescan_entered = 1; // do NOT run mmc_rescan for the first time
        } else {
/* fix            mmc->host_rescan_disable = false; */
